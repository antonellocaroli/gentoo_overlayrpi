...
SRC_URI="
	amd64? ( https://www.signalyst.eu/bins/naa/linux/stretch/${MY_PN}_${PV}-41_amd64.deb )
	x86?   ( https://www.signalyst.eu/bins/naa/linux/stretch/${MY_PN}_${PV}-41_i386.deb )
	arm64? ( https://www.signalyst.eu/bins/naa/linux/stretch/${MY_PN}_${PV}-41_arm64.deb )
	arm?   ( https://www.signalyst.eu/bins/naa/linux/stretch/${MY_PN}_${PV}-41_armhf.deb )
"
